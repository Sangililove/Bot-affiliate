...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    """
    await context.bot.send_message(chat_id=update.effective_chat.id, text=f"Hello! This bot responds to Amazon links by adding an affiliate code!")
